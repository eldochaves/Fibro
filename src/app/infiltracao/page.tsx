...
export default async function InfiltracaoPage() {
  ...
  const available = isAvailableNow(
    ...
    profile?.questionnaire_requests?.["infiltracao_tend"]
  );
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-6">
        ...
        <h1 className="font-display text-2xl font-semibold text-navy-800">
          Como foi a sua infiltração?
        </h1>
        <p className="mb-6 mt-1 text-sm text-navy-500">
          Um retorno rápido sobre o procedimento que você realizou.
        </p>
